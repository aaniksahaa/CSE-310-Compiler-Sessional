...
const int NUMBER_OF_BUCKETS = 11;

/***    USAGE    ***/

/*

I name type = Insert into current scope
L name      = Lookup from whole symboltable
...
int main()
{
	...
	int number_of_buckets_in_scopetables = NUMBER_OF_BUCKETS;
